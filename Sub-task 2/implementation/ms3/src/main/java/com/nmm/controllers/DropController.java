...
public class DropController {
	...
	@GetMapping("load")
	public ModelAndView getDrop() throws ClassNotFoundException, SQLException {
		setConnection();
		sort();
		setConnection();
		List<Message> storedMessages = select.getAllDrops();
		...
		modelAndView.setViewName("drop");
		System.out.println("========ljista dropanih===========");
		System.out.println(list);
		System.out.println("===================");
		return modelAndView;
	}
